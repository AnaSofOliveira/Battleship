...
public class Navio {
    ...
    private String nome;
    private char tipo;
    private coordinate localizacao_inicial;
    private coordinate localizacao_final;
    private int tamanho;

    public Navio(char sigla, coordinate ini_loc, coordinate fin_loc){
        /**
    ...
    public coordinate getLocalizacao_inicial() {
        return localizacao_inicial;
    }

    public coordinate getLocalizacao_final() {
